...
from main.views import logout_user, login_user, register, show_main, create_news, show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, edit_news, delete_news, add_news_entry_ajax
